...
p = figure(plot_width=600, plot_height=400, x_axis_label='Cost of vehicle ($)', y_axis_label='Cost ($)', tooltips=TOOLTIPS)
...
with open('graph/final/fog_cost/csv/200_1-20_M.csv', 'w', newline='') as csvfile:
    ...
    writer.writerow(['Cost of vehicle', 'Total Cost', 'Edge Cost', 'Fog Cost'])
