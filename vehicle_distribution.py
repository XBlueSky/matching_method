...
for distribution_type in range(1, 3):
    ...
    #     sd = 15
        ...
        if total_edge_cost == 0:
            ...
            total_edge_CP_list.append(total_edge_cost)
        ...
        if total_fog_cost == 0:
            ...
            total_fog_CP_list.append(total_fog_cost)

        if distribution_type == 1:
            total_uniform_list.append(total_edge_cost + total_fog_cost)
        elif distribution_type == 2:
            total_exponential_list.append(total_edge_cost + total_fog_cost)
...
p.line(xaxis_list, total_exponential_list, legend="Exponential distribution", line_width=1, line_color="orange")
...
p.circle(xaxis_list, total_exponential_list, legend="Exponential distribution", fill_color="white", line_color="orange", size=5)
...
export_svgs(p, filename="graph/vehicle_distribution/same_vehicles/1000_vehicles_L.svg")

with open('graph/vehicle_distribution/same_vehicles/csv/1000_vehicles_L.csv', 'w', newline='') as csvfile:
