...
export_svgs(p, filename="graph/final/algo/straightforward/0-200_normal_S_cost.svg")

with open('graph/final/algo/straightforward/csv/0-200_normal_S_cost.csv', 'w', newline='') as csvfile:
